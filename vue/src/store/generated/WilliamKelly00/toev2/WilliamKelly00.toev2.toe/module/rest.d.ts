 ...
 */
export declare type ToeParams = object;
export interface ToeQna {
    index?: string;
    qsh?: string;
    parentTopic?: string;
    question?: string;
...
export interface ToeQueryAllQnaResponse {
    qna?: ToeQna[];
    /**
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     * @request GET:/WilliamKelly00/toev2/toe/params
     */
    queryParams: (params?: RequestParams) => Promise<HttpResponse<ToeQueryParamsResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
     * @name QueryQnaAll
     * @summary Queries a list of Qna items.
     * @request GET:/WilliamKelly00/toev2/toe/qna
     */
    queryQnaAll: (query?: {
    ...
    }, params?: RequestParams) => Promise<HttpResponse<ToeQueryAllQnaResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
     * @name QueryQna
     * @summary Queries a Qna by index.
