...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryParams = (params: RequestParams = {}) =>
    this.request<ToeQueryParamsResponse, RpcStatus>({
      path: `/WilliamKelly00/toev2/toe/params`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryQnaAll = (
    ...
    this.request<ToeQueryAllQnaResponse, RpcStatus>({
      path: `/WilliamKelly00/toev2/toe/qna`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
